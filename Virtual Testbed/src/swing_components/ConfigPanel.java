...
public class ConfigPanel extends JPanel{
	...
	public ConfigPanel() {
		...
		wingXPanel = new ValuePanel("WingX:", 0.5f);
		tailSizePanel = new ValuePanel("Tail Size:", 0.5f);
		engineMassPanel = new ValuePanel("Engine Mass:", 0.25f);
		wingMassPanel = new ValuePanel("Wing Mass:", .25f);
		tailMassPanel = new ValuePanel("Tail Mass:", .125f);
		maxThrustPanel = new ValuePanel("Max Thrust:", 5);
		maxAOAPanel = new ValuePanel("Max AOA:", .53f);
		wingSlopePanel = new ValuePanel("Wing LiftSlope:", 0.2f);
		horStabSlopePanel = new ValuePanel("Horizontal Stab LiftSlope:", 0.2f);
		verStabSlopePanel = new ValuePanel("Vertical Stab LiftSlope:", 0.2f);
