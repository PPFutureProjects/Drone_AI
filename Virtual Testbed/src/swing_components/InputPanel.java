...
public class InputPanel extends JPanel {
	...
	private CubeAdderPanel cubePanel;
	...
	public void setSettingsListener(SettingsListener listener) {
		...
		cubePanel.addSettingsListener(listener);
	}
	...
	public void updateVelocityLabels(Vector3f velocity, Vector3f angularVelocity, Vector3f position) {
		infoPanel.updateVelocityLabels(velocity, angularVelocity, position);
	}
