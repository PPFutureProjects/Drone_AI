...
public class Matrix {
	...
	// Set the matrix to random integers between -1 and 1
	void randomize() {
		for (int i = 0; i < rows; i++) {
			for (int j = 0; j < cols; j++) {
	...
	/// Return a matrix which is this matrix PLUS parameter matrix
	Matrix add(Matrix n) {
	...
	// Return a matrix which is this matrix MINUS parameter matrix
	...
	// Return a matrix which is this matrix TIMES parameter matrix (element wise
	// multiplication)
