...
//  }
  ...
  */
  ...
  static {
    mouseMap.put(MouseEvent.MOUSE_PRESSED, neural_net.event.MouseEvent.PRESS);
    mouseMap.put(MouseEvent.MOUSE_RELEASED, neural_net.event.MouseEvent.RELEASE);
    mouseMap.put(MouseEvent.MOUSE_CLICKED, neural_net.event.MouseEvent.CLICK);
    mouseMap.put(MouseEvent.MOUSE_DRAGGED, neural_net.event.MouseEvent.DRAG);
    mouseMap.put(MouseEvent.MOUSE_MOVED, neural_net.event.MouseEvent.MOVE);
    mouseMap.put(MouseEvent.MOUSE_ENTERED, neural_net.event.MouseEvent.ENTER);
    mouseMap.put(MouseEvent.MOUSE_EXITED, neural_net.event.MouseEvent.EXIT);
  }
  ...
  protected void fxMouseEvent(MouseEvent fxEvent) {
    ...
    if (fxEvent.isShiftDown()) {
      modifiers |= neural_net.event.Event.SHIFT;
    }
    if (fxEvent.isControlDown()) {
      modifiers |= neural_net.event.Event.CTRL;
    }
    if (fxEvent.isMetaDown()) {
      modifiers |= neural_net.event.Event.META;
    }
    if (fxEvent.isAltDown()) {
      modifiers |= neural_net.event.Event.ALT;
    }
    ...
    sketch.postEvent(new neural_net.event.MouseEvent(fxEvent, when,
                                                     action, modifiers,
                                                     x, y, button, count));
  }
  ...
  protected void fxScrollEvent(ScrollEvent fxEvent) {
    ...
    int action = neural_net.event.MouseEvent.WHEEL;
  ...
  protected void fxKeyEvent(javafx.scene.input.KeyEvent fxEvent) {
    ...
    if (et == KeyEvent.KEY_PRESSED) {
      action = neural_net.event.KeyEvent.PRESS;
    } else if (et == KeyEvent.KEY_RELEASED) {
      action = neural_net.event.KeyEvent.RELEASE;
    } else if (et == KeyEvent.KEY_TYPED) {
      action = neural_net.event.KeyEvent.TYPE;
    }
    ...
    sketch.postEvent(new neural_net.event.KeyEvent(fxEvent, when,
                                                   action, modifiers,
                                                   keyChar, keyCode));
  }
