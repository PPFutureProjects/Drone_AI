...
import neural_net.data.*;
import neural_net.event.*;
import neural_net.opengl.*;
...
//        if (objects[i] == object && methods[i].equals(method)) {
  ...
  public void registerMethod(String methodName, Object target) {
    if (methodName.equals("mouseEvent")) {
      registerWithArgs("mouseEvent", target, new Class[] { neural_net.event.MouseEvent.class });

    } else if (methodName.equals("keyEvent")) {
      registerWithArgs("keyEvent", target, new Class[] { neural_net.event.KeyEvent.class });

    } else if (methodName.equals("touchEvent")) {
      registerWithArgs("touchEvent", target, new Class[] { neural_net.event.TouchEvent.class });
 ...
 */
   ...
   */
  public void postEvent(neural_net.event.Event pe) {
    eventQueue.add(pe);
